...
(function (document) {
    ...
    app.addEventListener('dom-change', function () {
        console.log('TPA Bootstrap is ready to rock!');
        app.$.push.enable();
    });
    ...
    app.menuItemSelected = function (selectedItem) {
        ...
        var matchingSection = selectedItem.items.find(function (f) {
            return f.attributes["data-route"].value == app.data.pageName
        });
