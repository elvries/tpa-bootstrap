...
And you can run it via:
	...
	polylint -i tpa-daily-banking.html
...
`http://localhost:8080/components/tpa-daily-banking/`, where `tpa-daily-banking` is the name of the directory containing it.


## Testing Your Element

Simply navigate to the `/test` directory of your element to run its tests. If
you are using Polyserve: `http://localhost:8080/components/tpa-daily-banking/test/`
